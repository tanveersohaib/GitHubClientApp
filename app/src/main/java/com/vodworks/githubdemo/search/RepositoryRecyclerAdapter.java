package com.vodworks.githubdemo.search;
...
import com.vodworks.githubdemo.repositoryView.codeFragment.ItemClickListener;
import com.vodworks.githubdemo.models.ItemPOJO;
import com.vodworks.githubdemo.R;
import com.squareup.picasso.Picasso;

import java.util.List;

public class RepositoryRecyclerAdapter extends RecyclerView.Adapter<RepositoryRecyclerAdapter.CustomViewHolder> {

        private List<ItemPOJO> dataList;
        private Context context;
        private ItemClickListener clickListener;

        public RepositoryRecyclerAdapter(Context context, List<ItemPOJO> dataList){
        ...
        public void loadData(List<ItemPOJO> data){
            dataList = data;
