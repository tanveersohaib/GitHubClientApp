...
import com.vodworks.githubdemo.models.OttoDataObject;
...
public class PathRecyclerAdapter extends RecyclerView.Adapter<PathRecyclerAdapter.CustomViewHolder> {
    ...
    PathRecyclerAdapter(ArrayList<String> items, String ref){
        this.items = items;
        this.ref = ref;
    }
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        return new PathRecyclerAdapter.CustomViewHolder(view);
